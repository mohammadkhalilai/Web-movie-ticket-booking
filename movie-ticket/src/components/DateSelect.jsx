  ...
  return(
    <div  id='dateSelect' className="pt-30">
      <div className="flex flex-col md:flex-row items-center justify-between gap-10
       relative p-8 bg-red-500/10 border-red border-opacity-20 rounded-lg">
            ...
            <button onClick={onBookHandler} className="bg-red-600 text-white px-8 py-2 mt-6 rounded
             hover:bg-red-400 bg-opacity-90 transition duration-300 cursor-pointer">Book Now</button>
      </div>
